...
pretrainfile ='bert-base-uncased'
Electratokenizer = BertTokenizer.from_pretrained(pretrainfile)
Electramodel = bertModel.ElectraForQuestionAnswering(pretrainfile=pretrainfile)
...
try:
    ...
    Electramodel = load_checkpoint(checkpoint_file,'bert_task2.pth',Electramodel)
except:
...
#                step_loss = 0
            ...
            if iteration % 400 == 0:
                checkpoint_file = '../checkpoint_bert_task2'
                save_checkpoint(checkpoint_file,'bert_task2.pth',DS_model,model_optimizer,parallel)
        ...
        pd_total_loss.to_csv('./total_loss_finetune_bert.csv', sep = ',')
    print(total_loss)
...
if task == 'train':
    ...
    submit.to_csv('./data/val_submit_bert.csv',index=None,sep=';',encoding='utf-8')
    ...
    submit.to_csv('./data/task2_method2.csv',index=None,sep=';',encoding='utf-8')
